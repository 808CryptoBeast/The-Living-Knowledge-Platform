...
(function () {
  ...
  const LESSON_IMAGE_REGISTRY = {
    ...
    'km-hokuleaa':    { url:'assets/images/km-hokuleaa.jpg',           pos:'center 55%',     credit:"Hōkūleʻa — Polynesian Voyaging Society / Wikimedia Commons" },
    'km-loikalo':     { url:'assets/images/km-loikalo.jpg',            pos:'center 50%',     credit:"Hanalei Valley Loʻi Kalo — Wikimedia Commons" },
    'km-ahupuaa':     { url:'assets/images/km-ahupuaa.jpg',            pos:'center 45%',     credit:"Nuʻuanu Valley — Wikimedia Commons" },
    'km-kumulipo':    { placeholder:true, filename:'assets/images/km-kumulipo.jpg',    hint:'Deep night sky over ocean — stars, first light emerging' },
    'km-wakea':       { placeholder:true, filename:'assets/images/km-wakea.jpg',       hint:'Sky meeting ocean horizon — Wākea and Papahānaumoku' },
    'km-olelo':       { placeholder:true, filename:'assets/images/km-olelo.jpg',       hint:'Hawaiian kapa cloth patterns or traditional chant imagery' },
    'km-hula':        { placeholder:true, filename:'assets/images/km-hula.jpg',        hint:'Hula dancers in traditional kapa — flowing, grounded movement' },
    'km-laau':        { placeholder:true, filename:'assets/images/km-laau.jpg',        hint:'Hawaiian medicinal plants — ʻolena, noni, kalo leaves' },
